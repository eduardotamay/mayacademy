...
class Order extends Model
{
    ...
    protected $fillable = ['recipient_name','line1','line2','city','country_code','state',
                            'postal_code','email','shopping_cart_id','status','total','guide_number'];

    public function sendMail()
    {
        // Agregar las clases para enviar el mail
        Mail::to("kaambaltic@gmail.com")->send(new OrderCreated($this));
    }

    public function sendUpdatedMail()
    {
        // Actualizar datos en el correo del cliente
        Mail::to("kaambaltic@gmail.com")->send(new OrderUpdated($this));
    }
