                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h1 id="Tittle-updated" class="h1">Actualización de tu pago en MAYACADEMY</h1>
																<strong>{{$order->email}}</strong> 
																Te enviamos lo datos actualizados de tu compra realizado con nosotros
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                    	<td valign="top" style="padding-top:0; padding-bottom:0;">
                                                          <table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
															  <tr>Estado Actual del curso {{$order->status}}</tr>
                                                              <tr>
															...
															@endforeach
															<tr>
																<td valign="top" class="dataTableContent" mc:edit="data_table_content00"></td>
																<td valign="top" class="dataTableContent" mc:edit="data_table_content01">
																  Total
																</td>
																<td valign="top" class="dataTableContent" mc:edit="data_table_content02">
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content01">
                                                                Contactanos en <a href="http://www.mayacademy.com/contact" target="_blank">MAYACADEMY</a> Si tienes alguna duda con el recibo de tu pago, o si tienes problemas tecnicos con la plataforma.
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                            	...
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div mc:edit="std_content02">
                                                                        	<a id="button-info" href="{{url('/buy/'.$order->shoppingCartID())}}" target="_blank">Haz click para más información</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
